...
2026年時点のNext.js 16ベストプラクティスに基づく構成。Feature-based + Colocation パターンを採用し、各詳細ページへのルーティングを網羅する。
...
│   │   │   │   ├── scenes/
│   │   │   │   │   ├── page.tsx          # 贈るシーン一覧
│   │   │   │   │   └── [slug]/page.tsx   # シーン別商品一覧 (例: /scenes/birthday)
│   │   │   │   ├── gift-builder/page.tsx # メッセージカード・のし等のオプション選択
│   │   │   │   └── checkout/
│   │   │   │       ├── page.tsx          # チェックアウト (ゲスト購入可)
│   │   │   │       └── success/page.tsx  # 注文完了画面 (Flower Impact演出)
│   │   │   │
│   │   │   ├── (account)/                # アカウント関連 (要認証レイアウト)
│   │   │   │   ├── dashboard/page.tsx    # 顧客マイページトップ
│   │   │   │   ├── orders/
│   │   │   │   │   ├── page.tsx          # 注文履歴
│   │   │   │   │   └── [id]/page.tsx     # 注文詳細 (Flower Story / Timeline表示)
│   │   │   │   ├── addresses/page.tsx    # お届け先アドレス帳
│   │   │   │   ├── reminders/page.tsx    # 誕生日リマインダー管理
│   │   │   │   ├── flower-miles/page.tsx # Flower Miles 残高・ランク表示
│   │   │   │   └── flower-impact/page.tsx# Flower Map / CO2削減量 / バッジ一覧
│   │   │   │
│   │   │   ├── (content)/                # コンテンツ関連 (静的寄り)
│   │   │   │   ├── about/page.tsx        # ブランドストーリー (ロスフラワー解決への想い)
│   │   │   │   ├── sustainability/page.tsx# サステナビリティへの取り組み
│   │   │   │   └── faq/page.tsx          # よくある質問 / ドライフラワーの作り方
│   │   │   │
│   │   │   ├── egift/
│   │   │   │   └── [token]/page.tsx      # eギフト受け取り画面 (住所入力)
│   │   │   │
│   │   │   └── legal/                    # 法的ページ
│   │   │       ├── terms/page.tsx
│   │   │       ├── privacy/page.tsx
│   │   │       └── commerce/page.tsx     # 特定商取引法に基づく表記
│   │   │
│   │   ├── api/                          # Route Handlers (外部連携)
│   │   │   ├── webhook/stripe/route.ts   # Stripe決済完了Webhook
│   │   │   └── webhook/line/route.ts     # LINE Bot Webhook
│   │   │
...
│   │   ├── supabase/client.ts            # クライアント用クライアント
│   │   ├── supabase/server.ts            # RSC / Server Actions用クライアント
│   │   └── utils.ts                      # cn (Tailwind merge) 等
│   │
│   ├── i18n/                             # next-intl 設定
│   └── messages/                         # 翻訳用JSONファイル
│
├── public/                               # 静的アセット (フォント等)
